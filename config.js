...
const i18n = {
    en: {
        ...
        pdfSheetSerial: "Sheet Serial:", pdfReceiptNo: "Receipt ID:", pdfDownloaded: "Downloaded:", pdfSpaRecord: "SPA Record"
    },
    ar: {
        ...
        pdfHotelName: "فندق وفيلا رمال", pdfHotelSub: "مدينة الرويس، أبوظبي - الإمارات العربية المتحدة",
        pdfLaundryService: "خدمة المغسلة", pdfRoom: "الغرفة:", pdfDate: "التاريخ:", pdfGuest: "اسم الضيف:",
        pdfRoomTyp: "نوع الغرفة:", pdfAgency: "الوكالة:", pdfQuota: "حصص المغسلة:", pdfAgent: "الموظف:",
        pdfPackaging: "التعبئة:", pdfItem: "الصنف", pdfQty: "الكمية", pdfTotal: "المجموع",
        pdfTotalPieces: "مجموع القطع:", pdfGrandTotalText: "المجموع الإجمالي:", pdfNotes: "ملاحظات / عيوب الملابس:",
        pdfProofPhoto: "صورة الإثبات:", pdfHotelCount: "عداد الفندق", pdfHotelCountFree: "عداد الفندق (مجاني)",
        pdfHotelExtra: "الفندق وإضافي", pdfGuestCount: "عداد الضيف (كامل)", pdfSpaSheet: "ورقة مغسلة سبا في إيلمنت",
    ...
    hi: {
        ...
        pdfHotelName: "रेमल होटल एंड विला", pdfHotelSub: "अल रुwais सिटी, अबू धाبي - यूएई",
        pdfLaundryService: "लॉन्ड्रि सेवा", pdfRoom: "कमरा:", pdfDate: "दिनांक:", pdfGuest: "अतिथि का नाम:",
        pdfRoomTyp: "कमरे का प्रकार:", pdfAgency: "एजेंसी:", pdfQuota: "लॉन्ड्री कोटा:", pdfAgent: "कर्मचारी:",
        pdfPackaging: "पैकेजिंग:", pdfItem: "आइटम", pdfQty: "मात्रा", pdfTotal: "कुल",
        pdfTotalPieces: "कुल पीस:", pdfGrandTotalText: "कुल योग:", pdfNotes: "कपड़े के नोट्स / दोष:",
        pdfProofPhoto: "प्रमाण फोटो:", pdfHotelCount: "होटल काउंट", pdfHotelCountFree: "होटل काउंट (मुफ्त)",
        pdfHotelExtra: "होटल और अतिरिक्त", pdfGuestCount: "अतिथि काउंट (पूर्ण)", pdfSpaSheet: "वी एलिमेंट स्पा लॉन्ड्रि शीट",
...
const database = {
    ...
    pressing: {
        "GENTLEMEN": [
            ...
            { name: "Lungi", ar: "وزار", price: 12 }, { name: "T-Shirt", ar: "قميص خفيف", price: 10 }, { name: "Overall", ar: "افرول", price: 36 },
